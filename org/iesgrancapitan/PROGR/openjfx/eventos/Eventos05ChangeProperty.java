...
package org.iesgrancapitan.PROGR.openjfx.eventos;
...
public class Eventos05ChangeProperty extends Application {
  ...
  public void start(Stage primaryStage) throws Exception {
    ...
    TextArea tf3 = new TextArea("En la caja de texto superior solo puedes escribir números decimales.");
    tf3.setWrapText(true);

    VBox root = new VBox(tf1, tf3);

    Scene scene = new Scene(root, 300, 225);
    scene.getStylesheets().add(getClass().getResource("/org/iesgrancapitan/PROGR/openjfx/vistas/estilos.css").toExternalForm());

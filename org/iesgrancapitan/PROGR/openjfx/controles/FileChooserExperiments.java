...
public class FileChooserExperiments extends Application {
  ...
  public void start(Stage primaryStage) throws IOException {
    ...
    var fxml = new FXMLLoader(getClass().getResource("view/FileChooserExperiments.fxml"));
    var root = fxml.<Pane>load();
    
    Scene scene = new Scene(root, 750, 400);
    scene.getStylesheets().add(getClass()
        .getResource("/org/iesgrancapitan/PROGR/openjfx/vistas/estilos.css").toExternalForm());

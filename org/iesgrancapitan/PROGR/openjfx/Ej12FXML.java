...
public class Ej12FXML extends Application {
  ...
  public void start(Stage primaryStage) throws IOException {
    ...
    fxml1.setLocation(Ej12FXML.class.getResource("vistas/Ej12FXML.fxml"));
    FXMLLoader fxml2 = new FXMLLoader(this.getClass().getResource("vistas/Ej12FXML2.fxml"));
    FXMLLoader fxml3 = new FXMLLoader(this.getClass().getResource("vistas/Ej12FXML3.fxml"));
